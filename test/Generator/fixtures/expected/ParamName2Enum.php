...
class ParamName2Enum
{
    ...
    public function setSomeArray(array $value): ParamName2Enum
    {
        $items = $this
            ...
            ->filter(function(EnumeratorCompatibleEntityInterface $object) {
                return $object->getName() === \Hostnet\Component\AccessorGenerator\Generator\fixtures\ParamName2::A_SOME_ARRAY;
            });
    ...
    public function setSomeString(string $value): ParamName2Enum
    {
        $items = $this
            ->collection
            ->filter(function(EnumeratorCompatibleEntityInterface $object) {
                return $object->getName() === \Hostnet\Component\AccessorGenerator\Generator\fixtures\ParamName2::S_SOME_STRING;
            });
    ...
    public function setSomeInteger(int $value): ParamName2Enum
    {
        $items = $this
            ->collection
            ->filter(function(EnumeratorCompatibleEntityInterface $object) {
                return $object->getName() === \Hostnet\Component\AccessorGenerator\Generator\fixtures\ParamName2::I_SOME_INTEGER;
            });
    ...
    public function setSomeFloat(float $value): ParamName2Enum
    {
        $items = $this
            ->collection
            ->filter(function(EnumeratorCompatibleEntityInterface $object) {
                return $object->getName() === \Hostnet\Component\AccessorGenerator\Generator\fixtures\ParamName2::F_SOME_FLOAT;
            });
    ...
    public function setSomeBoolean(bool $value): ParamName2Enum
    {
        $items = $this
            ->collection
            ->filter(function(EnumeratorCompatibleEntityInterface $object) {
                return $object->getName() === \Hostnet\Component\AccessorGenerator\Generator\fixtures\ParamName2::B_SOME_BOOLEAN;
            });
